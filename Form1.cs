...
namespace МакДональдс
{
    public partial class Form1 : Form
    {
        ...
        {
            productClassBindingSource.DataSource = Helper.LoadTxt("C:\\Users\\Lenovo\\Desktop\\ЛАБА4 ООП\\МакДональдс\\ProductsList.txt");
        }
        ...
        {
            productClassBindingSource.DataSource = Helper.LoadJson("products.json");
        }
    }
}
